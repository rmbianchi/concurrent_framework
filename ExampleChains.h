...
std::vector<AlgoBase*> exampleChain2(){
    std::vector<AlgoBase*> algos;
    AlgoBase* algo0 = new ToyAlgo("algo0",1, 1); algo0->produces("DataTypeA");
    AlgoBase* algo1 = new ToyAlgo("algo1",2, 1); algo1->reads("DataTypeA"); algo1->produces("DataTypeE");
    AlgoBase* algo2 = new ToyAlgo("algo2",3, 3); algo2->produces("DataTypeB");
	AlgoBase* algo3 = new ToyAlgo("algo3",4, 1); algo3->reads("DataTypeB");algo3->produces("DataTypeC");
    AlgoBase* algo4 = new ToyAlgo("algo4",4, 1); algo4->reads("DataTypeC");algo4->produces("DataTypeE");
    AlgoBase* algo5 = new ToyAlgo("algo5",4, 1); algo5->produces("DataTypeD");
    AlgoBase* algo6 = new ToyAlgo("algo6",4, 1); algo6->reads("DataTypeB");
    algos.push_back(algo0);
    algos.push_back(algo1);
    algos.push_back(algo2);
    algos.push_back(algo3);	
